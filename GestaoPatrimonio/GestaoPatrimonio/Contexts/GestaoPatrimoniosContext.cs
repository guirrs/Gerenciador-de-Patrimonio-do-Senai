...
public partial class GestaoPatrimoniosContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AreaID).HasName("PK__Area__70B82028E34E113D");

            entity.HasIndex(e => e.NomeArea, "UQ__Area__9A779760983615CF").IsUnique();
        ...
        {
            entity.HasKey(e => e.BairroID).HasName("PK__Bairro__4A0936232AECEBC9");
        ...
        {
            entity.HasKey(e => e.CargoID).HasName("PK__Cargo__B4E665EDFC81B1FB");

            entity.HasIndex(e => e.NomeCargo, "UQ__Cargo__4D9FD7DEC71ED0ED").IsUnique();
        ...
        {
            entity.HasKey(e => e.CidadeID).HasName("PK__Cidade__B6800959CE2765D4");
        ...
        {
            entity.HasKey(e => e.EnderecoID).HasName("PK__Endereco__B9D9462FE1A168A1");
        ...
        {
            entity.HasKey(e => e.LocalizacaoID).HasName("PK__Localiza__83ABDECA1E122FD9");
        ...
        {
            entity.HasKey(e => e.LogPatrimonioID).HasName("PK__LogPatri__E716D12B4432BFA3");
        ...
        {
            entity.HasKey(e => e.PatrimonioID).HasName("PK__Patrimon__C5A60BDE995BFAAC");

            entity.ToTable(tb => tb.HasTrigger("trg_Patrimonio_SoftDelete"));

            entity.HasIndex(e => e.NumeroPatrimonio, "UQ__Patrimon__3BC8B35DB32AC2D1").IsUnique();
        ...
        {
            entity.HasKey(e => e.TransferenciaID).HasName("PK__Solicita__E5B4F5F2292F12F7");
        ...
        {
            entity.HasKey(e => e.StatusPatrimonioID).HasName("PK__StatusPa__B3F336092C6661C3");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusPa__C5C60F1A299FB734").IsUnique();
        ...
        {
            entity.HasKey(e => e.StatusTransferenciaID).HasName("PK__StatusTr__7AA828B97483E423");

            entity.HasIndex(e => e.NomeStatus, "UQ__StatusTr__C5C60F1A734DCAF1").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoAlteracaoID).HasName("PK__TipoAlte__9BEF4F0DB2DEA9BE");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoAlte__7859A10ADA80030C").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoPatrimonioID).HasName("PK__TipoPatr__4DC9FF99E6EF0118");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoPatr__7859A10A64C9F154").IsUnique();
        ...
        {
            entity.HasKey(e => e.TipoUsuarioID).HasName("PK__TipoUsua__7F22C7025CDFD0CD");

            entity.HasIndex(e => e.NomeTipo, "UQ__TipoUsua__7859A10ABC83B80B").IsUnique();
        ...
        {
            entity.HasKey(e => e.UsuarioID).HasName("PK__Usuario__2B3DE7982A6EF60A");

            entity.ToTable(tb => tb.HasTrigger("trg_Usuario_SoftDelete"));

            entity.HasIndex(e => e.RG, "UQ__Usuario__321537C8CFAF258A").IsUnique();

            entity.HasIndex(e => e.CarteiraTrabalho, "UQ__Usuario__6E25BCA2769F93DE").IsUnique();

            entity.HasIndex(e => e.Email, "UQ__Usuario__A9D1053430F4B2C0").IsUnique();

            entity.HasIndex(e => e.CPF, "UQ__Usuario__C1F89731073D88C9").IsUnique();

            entity.HasIndex(e => e.NIF, "UQ__Usuario__C7DEC33019169C4C").IsUnique();
